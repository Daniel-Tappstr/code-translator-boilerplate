...
export default function Home() {
  ...
  const [outputLanguage, setOutputLanguage] = useState('Natural Language');
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      {/* translate button */}
      <button disabled={loading} className='bg-white  border-white p-3 m-2 flex justify-center items-center rounded-lg text-black font-semibold' onClick={handleTranslate}>{loading ? `Translating...` : `Translate`}</button>
